...
class PhLevelSensorScreen extends StatefulWidget {
  const PhLevelSensorScreen({super.key});

  @override
  State<PhLevelSensorScreen> createState() => _PhLevelSensorScreenState();
}

class _PhLevelSensorScreenState extends State<PhLevelSensorScreen> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              CircularPercentIndicator(
                  ...
                  animation: true,
                  percent: 0.3,
                  center: SvgPicture.asset( "assets/images/material-symbols_water-ph-outline-rounded.svg"),
                  footer: Text(
                    "30%",
